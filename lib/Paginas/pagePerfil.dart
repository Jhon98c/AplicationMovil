...
class pagePerfil extends StatefulWidget {
  @override
  _perfilStatePage createState() => _perfilStatePage();
}

class _perfilStatePage extends State<pagePerfil> with TickerProviderStateMixin {
  ...
  //botones
  List<String> _icons = ['Todos', 'guardados', 'favortios', 'Proceso'];
